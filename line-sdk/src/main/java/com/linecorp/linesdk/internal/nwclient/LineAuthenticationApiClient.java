...
public class LineAuthenticationApiClient {
    ...
    private static class OneTimePasswordParser
        ...
        @NonNull
        @Override
        public OneTimePassword parseJsonToObject(@NonNull JSONObject jsonObject) throws JSONException {
    ...
    private class IssueAccessTokenResultParser
        ...
        @NonNull
        @Override
        public IssueAccessTokenResult parseJsonToObject(
    ...
    private static class VerificationResultParser
        ...
        @NonNull
        @Override
        public AccessTokenVerificationResult parseJsonToObject(@NonNull JSONObject jsonObject) throws JSONException {
    ...
    private static class RefreshTokenResultParser
        ...
        @NonNull
        @Override
        public RefreshTokenResult parseJsonToObject(@NonNull JSONObject jsonObject) throws JSONException {
            String tokenType = jsonObject.getString("token_type");
            if (!AVAILABLE_TOKEN_TYPE.equals(tokenType)) {
                throw new JSONException("Illegal token type. token_type=" + tokenType);
            }
